...
![image info](https://github.com/upwindsecurity/terraform-aws-onboarding/raw/main/modules/aws-org-onboarding/.docs/AWSOrgScreenshot1.png)
## Account Types
...
The definition for the role can be found in the [iam_org_discovery_role](https://github.com/upwindsecurity/terraform-aws-onboarding/tree/main/modules/aws-org-onboarding/modules/iam_org_discovery_role) submodule, and its creation is conditional so that the role is only created in the
management account.
> [!TIP]
...
This role is defined in the [iam_account_service_role](https://github.com/upwindsecurity/terraform-aws-onboarding/tree/main/modules/aws-org-onboarding/modules/iam_account_service_role) submodule.
> [!TIP]
...
The definition for the role can be found in the [iam_cloudscanner_admin_role](https://github.com/upwindsecurity/terraform-aws-onboarding/tree/main/modules/aws-org-onboarding/modules/iam_cloudscanner_admin_role) submodule.
> [!TIP]
...
The role is defined in the [iam_cloudscanner_execution_role](https://github.com/upwindsecurity/terraform-aws-onboarding/tree/main/modules/aws-org-onboarding/modules/iam_cloudscanner_execution_role) submodule.
> [!TIP]
...
The role is defined in the [iam_cloudscanner_saas_customer_assume_role](https://github.com/upwindsecurity/terraform-aws-onboarding/tree/main/modules/aws-org-onboarding/modules/iam_cloudscanner_saas_customer_assume_role) submodule.
